# Powerarete zsh theme
# - Based on wedisagree theme (https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/wedisagree.zsh-theme)
# - PS1 modified to be similar to Powerline, but much faster
# - Install the patched fonts for Powerline (https://github.com/Lokaltog/powerline)
#
